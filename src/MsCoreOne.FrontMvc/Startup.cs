...
namespace MsCoreOne.FrontMvc
{
    public class Startup
    {
        private string BackendUrl => Configuration.GetValue<string>("FrontMvc:BackendUrl");
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(options =>
            {
                ...
                .AddOpenIdConnect("oidc", options =>
                {
                    ...
                    options.ClientId = "mscoreone-mvc";
                    ...
                    options.Scope.Add("api.mscoreone");
